# finance.get_profit_and_loss_statement function:

```plpgsql
CREATE OR REPLACE FUNCTION finance.get_profit_and_loss_statement(_date_from date, _date_to date, _user_id integer, _office_id integer, _factor integer, _compact boolean DEFAULT true)
RETURNS json
```
* Schema : [finance](../../schemas/finance.md)
* Function Name : get_profit_and_loss_statement
* Arguments : _date_from date, _date_to date, _user_id integer, _office_id integer, _factor integer, _compact boolean DEFAULT true

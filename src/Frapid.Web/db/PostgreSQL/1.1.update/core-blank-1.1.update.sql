-->-->-- src/Frapid.Web/db/PostgreSQL/1.1.update/src/01.types-domains-tables-and-constraints/tables-and-constraints.sql --<--<--


-->-->-- src/Frapid.Web/db/PostgreSQL/1.1.update/src/04.default-values/01.default-values.sql --<--<--


-->-->-- src/Frapid.Web/db/PostgreSQL/1.1.update/src/05.scrud-views/empty.sql --<--<--


-->-->-- src/Frapid.Web/db/PostgreSQL/1.1.update/src/06.functions-and-logic/empty.sql --<--<--
...
-->-->-- src/Frapid.Web/db/PostgreSQL/1.1.update/src/99.ownership.sql --<--<--
DO
$$
    DECLARE this record;
BEGIN

-->-->-- src/Frapid.Web/Areas/Frapid.SchemaUpdater/db/PostgreSQL/1.x/1.0/src/09.menus/0.menu.sql --<--<--
...
-->-->-- src/Frapid.Web/Areas/Frapid.SchemaUpdater/db/PostgreSQL/1.x/1.0/src/99.ownership.sql --<--<--
DO
$$
    DECLARE this record;
BEGIN
